 //**********************************************************************
//* ファイル名： calendar.js
//* 説明： カレンダーの出力JavaScript
//*　　　　calendarから呼び出される関数：getCalendarList（該当するカレンダー情報）
//*、	　 isHoliday（祝日かどうかを判別する）、setStyle(該当するスタイルを設定する)
...
//* 関数名：getCalendarList
//* 引数：yyyy, mm 
//* 説明：年と月を入力されると当月のDateObjectを配列形式に返却する
//*		　例）入力(2008,5)：2008年5月
//*           出力：2008年5月1日?31日までのデータObject配列
//**********************************************************************
...
//* 関数名：_getBusinessHolidays
//* 引数：yyyy, mm, num, yobi
//* 説明：該当する年月のnumだけ経過した曜日のデータObjectを求める
//*		　例）入力(2008,5,3,0)：2008年5月の3週目の日曜日
//*           出力：20080518のデータObject==>new Date(2008,5,18)
//**********************************************************************	
	...
	function setStyle(object, num) {
		switch (num) {
			...
			case OTHER_MONTH_STYLE:
				...
				break;	
			case TODAY_STYLE:
				object.style.backgroundColor = "#ffbfb4";
