...
calObj[0].daysClass["7/16"] = 'Holyday';
calObj[0].daysClass["8/11"] = 'Holyday';
calObj[0].daysClass["9/17"] = 'Holyday';
calObj[0].daysClass["9/24"] = 'Holyday';
calObj[0].daysClass["10/8"] = 'Holyday';
...
// クラス指定でURLが指定されている場合はそっちが優先
calObj[0].click = false;

// クリックした時に開くURL ( _YEAR_ : 年 / _MONTH_ : 月 / _DAY_ : 日 )
calObj[0].clickURI = '';

// クリック可能にしたいクラス名 (すべての日をクリック可能にする場合は空にする)
// Holyday と指定した場合はclassがHolyday指定された日付だけクリックできるようになる
